...
class XverticalSlider extends XverticalSliderEventTarget {
    ...
    #invokeCallback = function () {
        if (this.callback) {
            ...
            if(this.callbackScope) {
                this.callback.call(this.callbackScope, this._sliderContainer);
            }else{
    ...
    #createxVerticalSlider() {
        ...
        if (this.list != null) {
            ...
            if (datalist != null) {
                this._sliderContainer.appendChild(this.#createTicks(datalist.options));
            } else if (this.list instanceof Array) {
                this._sliderContainer.appendChild(this.#createTicks(this.list));                
            }
        }
    ...
    #createTicks(datalist) {
        ...
        for (let i = 0; i < datalist.length; i++) {
            ...
            Object.assign(tick.style, {
                ...
                width: (((option.label != "" && option.label != null) ? 10 : 5) + ((this.dual_ticks) ? this.width * 3 : 0)) + 'px',
                height: '2px',
                overflow: 'visible',
                display: 'block',
